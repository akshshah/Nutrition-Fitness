...
<div class="container">
	<div class="row">
		...
		<div class="col-md-6 col-xs-8">
			<h1 class="text-center" style="margin-top:20px;">Fat Lose Workout Schedule</h1><br>
			<div class="text-center">
				...
				<div id="week1" class="collapse" style="margin-top:10px;">
						...
						<div id="Monday1" class="collapse">
							<form action="Workout" class="form1" method="post">
								<table>
									...
									<tr>
										<td colspan=3><input style="margin-top:10px; background-color:white" type="submit" class="btn text-center" name="submit" value="Done"></td>
									</tr>
								</table>
							</form>
						</div>
					<button class="button" data-toggle="collapse" data-target="#Tues1"> <h4>Tuesday </h4>Cardio </button>
					...
					<button class="button" data-toggle="collapse" data-target="#Wed1"> <h4>Wednesday </h4>Back</button>
					...
					<button class="button" data-toggle="collapse" data-target="#Thur1"> <h4>Thursday </h4>Cardio </button>
					...
					<button class="button" data-toggle="collapse" data-target="#Fri1"> <h4>Friday </h4>CST </button>
			...
			<div class="text-center" style="margin-top:20px;">
				...
				<div id="week2" class="collapse" style="margin-top:10px;">
					...
					<button class="button2" data-toggle="collapse" data-target="#Tues2"> <h4>Tuesday </h4>Cardio </button>
					...
					<button class="button2" data-toggle="collapse" data-target="#Wed2"> <h4>Wednesday </h4>Back </button>
					...
					<button class="button2" data-toggle="collapse" data-target="#Thur2"> <h4>Thursday </h4>Cardio </button>
					...
					<button class="button2" data-toggle="collapse" data-target="#Fri2"> <h4>Friday </h4>CST </button>
			...
			<div class="text-center" style="margin-top:20px;">
				...
				<div id="week3" class="collapse" style="margin-top:10px;">
					...
					<button class="button3" data-toggle="collapse" data-target="#Tues3"> <h4>Tuesday </h4>Cardio </button>
					...
					<button class="button3" data-toggle="collapse" data-target="#Wed3"> <h4>Wednesday </h4>Back </button>
					...
					<button class="button3" data-toggle="collapse" data-target="#Thur3"> <h4>Thursday </h4>Cardio </button>
					...
					<button class="button3" data-toggle="collapse" data-target="#Fri3"> <h4>Friday </h4>CST </button>
			...
			<div class="text-center" style="margin-top:20px;">
				...
				<div id="week4" class="collapse" style="margin-top:10px;">
					...
					<button class="button4" data-toggle="collapse" data-target="#Tues4"> <h4>Tuesday </h4>Cardio </button>
					...
					<button class="button4" data-toggle="collapse" data-target="#Wed4"> <h4>Wednesday </h4>Back </button>
					...
					<button class="button4" data-toggle="collapse" data-target="#Thur4"> <h4>Thursday </h4>Cardio </button>
					...
					<button class="button4" data-toggle="collapse" data-target="#Fri4"> <h4>Friday </h4>CST </button>
